...
for z in range(0, 4):
   for y in range(0,5):
      for x in range(0,5):
         fromMarkupsNode_0.AddFiducial(x*150, y*150, z*150)
...
for z in range(0, 4):
   for y in range(0,5):
      for x in range(0,5):
         fromMarkupsNode_1.AddFiducial(x*150, y*150, z*150)
...
for z in range(0, 4):
   for y in range(0,5):
      for x in range(0,5):
         fromMarkupsNode_2.AddFiducial(x*150, y*150, z*150)
...
for z in range(0, 4):
   for y in range(0,5):
      for x in range(0,5):
         fromMarkupsNode_3.AddFiducial(x*150, y*150, z*150)
